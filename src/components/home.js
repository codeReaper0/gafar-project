    ...
    <React.Fragment>
      <main className="xl:max-w-6xl mx-auto pt-11 pb-8 lg:py-16 px-4 lg:max-w-4xl xl:px-0">
        <section className="flex flex-col items-center gap-6 mb-14 relative">
          ...
          ></img>
          <h1 className="font-bold text-xl">Oseni Abdul-Gafar Anuoluwapo</h1>
        ...
        <section className="space-y-6">
          <a
            href="https://twitter.com/Olamposh"
            type="button"
            id="twitter"
            target="_blank"
          ...
          <a
            href="https://www.facebook.com/gafslaw"
            type="button"
            id="slack"
            target="_blank"
            className="text-lg font-medium w-full bg-[#EAECF0] border border-[#EAECF0] py-6 text-center rounded-lg"
          ...
          <a
            href="https://www.instagram.com/olamposhhh"
            type="button"
            id="btn_zuri"
            target="_blank"
            className="text-lg font-medium w-full bg-[#EAECF0] border border-[#EAECF0] py-6 text-center rounded-lg"
          ...
          <a
            href="https://www.linkedin.com/in/oseni-olamiposi-1546b625a/"
            type="button"
            id="books"
            target="_blank"
        ...
        <section className="flex justify-center gap-6 py-6 mt-6">
          ...
          <div className="relative">
            ...
            <a
              href="https://github.com/olamposh"
              type="button"
              target="_blank"
      ...
      <footer className="pt-8 lg:pt-12 pb-2 xl:pb-12 px-4 xl:px-0">
        <section className="gap-4 md:gap-0 md:justify-between md:items-center py-8 max-w-7xl mx-auto border-t border-t-gray-200">
          <p className="text-gray-500 text-center">
            &copy;2022 OSENI ABDUL-GAFAR ANUOLUWAPO
          </p>
        </section>
      </footer>
    </React.Fragment>
